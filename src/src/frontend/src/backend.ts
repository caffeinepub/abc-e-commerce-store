...
import type { T as _T, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addCategory(arg0: T__2): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addProduct(arg0: T): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllCategories(): Promise<Array<T__2>> {
        if (this.processError) {
            try {
    ...
    async getAllProducts(): Promise<Array<T>> {
        if (this.processError) {
            try {
    ...
    async getProductById(arg0: ProductId): Promise<T | null> {
        if (this.processError) {
            try {
    ...
    async getUserCart(): Promise<Array<T__1>> {
        if (this.processError) {
            try {
    ...
    async searchProducts(arg0: string): Promise<Array<T>> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: ProductId, arg1: T): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n6(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_T]): T | null {
    return value.length === 0 ? null : value[0];
}
